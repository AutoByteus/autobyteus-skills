...
## Operating Mode
- Run in lesson-lock mode: execute this workflow first.
- If a step fails, use documented fallbacks in this file before trying anything new.
- If all documented fallbacks fail and no human gate exists, run bounded self-learning and promote successful patterns back into this file.
...
If a new reliable step or fallback is discovered, add it to this `lessons.md` immediately so future runs stay mechanical.
