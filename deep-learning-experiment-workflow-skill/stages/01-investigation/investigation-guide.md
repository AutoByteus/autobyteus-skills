...
- reading local code, configs, scripts, logs, checkpoints, and dataset loaders
- tracing current training and evaluation entrypoints
- inspecting data schemas, sampling logic, augmentations, and split assumptions
- reading open-source implementations or framework internals
- checking papers, model cards, or official documentation when needed
...
- Keep concrete evidence:
  ...
  - URLs,
  - search queries,
  - relevant logs or metric excerpts,
...
- current training and evaluation entrypoints
- current model, data, optimizer, scheduler, checkpoint, and metric flow as understood
