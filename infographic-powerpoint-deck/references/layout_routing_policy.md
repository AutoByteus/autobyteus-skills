...
2. By text budget:
   ...
   - `heavy` -> prefer `L3` or split into two slides
...
3. By style fit:
   ...
   - research / corporate packs tolerate more `L1`, `L2`, `L3`, `L7`
   - warm/editorial packs often work well as mixed decks

## Prompt-wording guardrail

- If you choose `L1`, `L2`, `L3`, `L7`, or `L8`, panel wording is expected because those layouts intentionally create a text panel or card system.
