...
- If the user wants classroom, lecture, textbook-like, reaction-scheme, or self-contained didactic explainer slides, prefer `research-academic`, `editorial-light`, or `clean-corporate` and bias the layout system toward `L9`, `L10`, or `L11`.
